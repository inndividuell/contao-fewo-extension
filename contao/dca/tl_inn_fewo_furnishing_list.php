...
use Contao\System;
use Contao\Versions;
$GLOBALS['TL_DCA']['tl_inn_fewo_furnishing_list'] = array
(
    // Config
    'config' => array
    (
    ...
    (
        ...
        (
            ...
            'showColumns'             => true,
            'label_callback'            => array('tl_inn_fewo_furnishing_list', 'getListData')
        ),
...
//				'button_callback'     => array('tl_inn_team_members', 'toggleIcon')
    ...
    (
        ...
        (
            ...
            'sql'                     => "varchar(64) NOT NULL default 'manufacturer'"
        ),
        'title' => array
        (
            'exclude'                 => true,
        ...
        (
            ...
            'inputType'             => 'radio',
            'eval'                    => ['multiple'=>false],
            'options_callback'        => ['tl_inn_fewo_furnishing_list', 'getFewoFields'],
            'sql'                   => 'blob  NULL'
        ),
 ...
 */
class tl_inn_fewo_furnishing_list extends Backend
{
    /**
    ...
    public function getListData($product,$label) {
        ...
        $html.= '<span class="title">' . strip_tags($product['title']);
