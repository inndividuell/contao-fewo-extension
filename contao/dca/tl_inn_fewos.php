...
//				'button_callback'     => array('tl_inn_team_members', 'toggleIcon')
    ...
    'palettes' => array
    (
        'default'                     => '{title_legend},name,additional_name,image,text,detail_page,custom_url,published;{data_legend},sliderImages,persons,beds,qm,balconies,parking_slots,bathrooms,furnishings,furnishings_list_elements;{address_legend},address_street,address_city,address_postcode;',
